						...
						<div class="inner">
								<header id="header">
									...
									<ul class="icons">
										...
										<li><a href="historial.html" class=" fa fa-book"><span class="label"></span></a></li>
	...
	if($registro["disponible_lib"] == 0)
	{
		...
		echo'
			<article style="display:flex;flex-direction:column;align-items:center;">
				<a href="verlibro.php?codlib='.$registro["cod_lib"].'" style="text-align:-webkit-center">
						<img src="./../images/'.$registro["imagen_lib"].'" alt="" height="350px"/>
				</a>
				<h3>'.$registro["titulo_lib"].'</h3>
				style="height:60px; width:80%; text-align:center; overflow: hidden;">
					<div>
				...
				<ul class="actions">
					...
					<li style="float:right;margin-left:50%;margin-top:10px;color:green"><abbr title="Libro disponible">
					<i class="fa fa-face-smile fa-beat fa-xl" ></i></abbr></li>			
				</ul>		
		...
		echo'
			<article >
				...
				<ul class="actions">
					...
					<i class="fa fa-face-smile fa-xl"></i></abbr></li>			
				</ul>		
