...
?>
                    <label for="" style="color:red">Tienes reservado préstamo de este libro pendiente de recoger. Si lo deseas tienes opción a anular esta reserva.</label>
                    <br><br>
							...
							<!-- Menu -->
                                ...
                                <section>
                                    ...
                                    <li class="icon solid fa-envelope"><a href="C:\Program Files\Mozilla Thunderbird\thunderbird.exe">alfonso@medellin.ef</a></li>
										...
										<li class="icon solid fa-newspaper">Politica de Privacidad</li>	
								</section>
								<footer id="footer">
